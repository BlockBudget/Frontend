            ...
            <div className="contribution-table flex  mt-8 flex-col">
                ...
                <thead>
					<tr className="bg-black">
						...
						<th className="border-none py-2 text-white text-left">Group name</th>
						<th className="border-none py-2 text-white text-left">Created by</th>
						<th className="border-none py-2 text-white text-left">Saving Amount</th>
                ...
                <tbody>
                        <tr>
						  ...
						  <td className="border-l-0 border-r-0 border  py-2 text-white">Brooklyn Simmons</td>

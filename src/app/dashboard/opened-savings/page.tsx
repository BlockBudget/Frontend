...
const SavingsPage = () => {
  ...
  const data = {
    ...
    datasets: [
      {
        label: 'Savings',
        data: [21.30, 22, 22.5, 23, 23.40, 24.35, 23.30, 21.35, 20, 22, 23, 24], // Exact data points
    ...
    <div className="p-8  text-white h-full">
      ...
      <div className="my-6 flex justify-between gap-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400">Available for withdrawal: <span className="text-lg text-white">Withdrawal not yet available</span></p>
        ...
        <div>
          <button className="px-6 w-[405px] h-12 py-2 bg-[#0E131E]  hover:bg-gray-700 border-2 border-gray-700 rounded-xl">Withdraw</button>
        </div>
      ...
      <div className="my-6 flex justify-between gap-6">
        ...
        <div>
          ...
          <p className="text-lg mt-2 font-bold">Next payment due: <span className="text-sm text-gray-400">Oct 4, 2024</span></p>
        ...
        <div className="flex space-x-4 my-2">
          ...
          <button className="px-6 h-12 py-2 w-48 bg-[#0E131E] rounded-xl hover:bg-gray-700 border-2 border-gray-700 ">Pay now</button>

          <button className="px-6 h-12 py-2 w-48 bg-[#0E131E] rounded-xl hover:bg-gray-700 border-2 border-gray-700">Pay all now</button>

				...
				<div className="flex flex-col md:col-span-9 col-span-1">
					...
					<div className="grid md:grid-cols-3 grid-cols-1  gap-3 py-5 text-center">
						<Link
							...
							className="flex w-full col-span-1 items-center justify-center m-auto  gap-2 py-2  bg-primary/10 rounded-full border border-white text-sm font-semibold "
						>
							<span>
								<LockKeyhole />
							</span>
						...
						<Link
							href="/dashboard/create-savings"
							className="flex items-center justify-center  col-span-1 w-full m-auto gap-2  py-2 bg-primary/10 rounded-full border border-white text-sm font-semibold "
						>
							<span>
								<Banknote />{" "}
							</span>
